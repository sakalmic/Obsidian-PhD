...
Current atomic register: CL-01–CL-07; CL-07 adds mandatory TCO. The current report and its PDF/CTU deck are the review package. Earlier alternative notes and PDFs are historical unless explicitly aligned to the 14 September baseline.
...
As reviewed on 7 September 2026, CL-01 through CL-06 were hypotheses and have no linked datasets or analyses. This describes the evidence register, not the existence or absence of historical raw data. The next useful deliverable is one traceable result from raw records to an analysis and a claim decision.
