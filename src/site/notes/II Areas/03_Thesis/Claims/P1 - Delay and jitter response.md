...
Within the frozen atmospheric operating domain, calibrated shot-level records permit estimation of the delay distribution and dispersion, conditional on voltage, session and electrode state. The analysis tests the contribution of measured laser/channel variables and reports either a supported relationship or a quantitative bound. Its direction, shape and possible saturation are empirical questions; monotonic shortening with irradiance is not assumed.
