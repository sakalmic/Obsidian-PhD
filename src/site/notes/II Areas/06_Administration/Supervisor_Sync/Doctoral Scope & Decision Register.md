...
| --- | --- | --- |
| D1 | Working CZ/EN title; C1/C2/C3/C4 | Candidate-selected; supervisor/committee and registered wording pending |
| D2 | Mandatory bounded laboratory TCO | Included in selected variant; academic adequacy for K13116 to be confirmed at review |
| D3 | Discussion date, format and time | Unconfirmed; previous 24 September placeholder and folder name are not an invitation |
| D4 | Study block, English and SDZ eligibility | Verify KOS and applicable individual requirements |
| D5 | Submission versus defence | August 2028 submission target; binding deadline and defence date separately unconfirmed |
| D6 | Primary apparatus and booking | Historical PERLA configuration does not establish future laser/HV/diagnostic access; confirm configuration and calibrations in WP0 |
| D7 | Earlier December 2026 IEEE manuscript | Identity relative to planned Paper 1 remains unresolved; preserve 1 September meeting record; current core targets November 2027 and April 2028 |
| D8 | Publication state and internationalisation | Confirm individual requirements, then track accepted/published/indexed separately |
| D9 | Language and monograph/collection | Working English outline; formal format decision pending |
| D10 | Tier 2/3 outside required completion | Explicit candidate instruction; separate funding/resources; no required CO₂/pressure or application paper |
| D11 | Historical acquisition provenance | Candidate-confirmed seven May 2024 series reused in ICOLSE/APL1–7 and three February 2025 series in APL8–10 |
| D12 | Number of shots/attempts per series | Deferred by candidate: author will resolve later; unsupported catalogue counts withdrawn |
| D13 | General irradiance–delay trend | Not adopted; verify original data, conditions and time origin before any general claim |
...
**Laserem iniciovaný průraz ve vysokonapěťových vzduchových mezerách za atmosférického tlaku: diagnostika laserem indukovaného kanálu, statistická predikce průrazu a technicko-ekonomický výběr provozních podmínek**
