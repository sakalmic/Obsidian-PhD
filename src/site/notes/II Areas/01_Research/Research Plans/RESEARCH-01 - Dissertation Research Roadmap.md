...
## Integration — Economics, papers and dissertation (Mar–Aug 2028)
...
1. **Mar–Apr:** combine performance uncertainty with equipment, electricity, operator, reset and replacement costs; compare shared-facility and dedicated-installation scenarios separately. Report feasible choices, sensitivity and break-even boundaries, or no demonstrated feasible/stable choice. Prepare Paper 2. See [[II Areas/03_Thesis/Claims/CL-07 - Techno-economic operating choice\|CL-07 - Techno-economic operating choice]].
2. **Through Jun:** write methods and limits while results mature; complete the full dissertation draft and check publication/study eligibility.
3. **Aug:** target dissertation submission. The defence date is a separate administrative milestone.
