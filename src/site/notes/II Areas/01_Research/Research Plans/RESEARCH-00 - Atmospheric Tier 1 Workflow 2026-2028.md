...
For the concise two-level schedule, start with [[RESEARCH-01 - Dissertation Research Roadmap]]. This ticket retains the detailed experiment–theory handoffs and completion rules.
...
| --- | --- | --- |
| 0 · Sep–Dec 2026 | [[LAB-00 - Apparatus and Timing Readiness|Apparatus and timing readiness]] | Approved configuration, calibrated measurement chain, shot schema, safe operating procedure and cost-log boundary. |
| 1 · Jan–Feb 2027 | [[LAB-01 - Atmospheric No-Laser Baseline|No-laser baseline]] | Contemporary $U_{50}$ estimate, uncertainty and session/electrode history. |
| 2 · Mar–Apr 2027 | [[LAB-02 - Laser and Channel Diagnostic Pilot|Laser and channel pilot]] | Measured optical inputs and one interpretable shot-linked channel descriptor, or a documented diagnostic limit. |
| 3 · May–Jun 2027 | [[LAB-03 - Screening and June Decision Gate|Screening and June gate]] | Small confirmatory matrix, precision-based attempt count, frozen analysis and explicit stop/go decision. |
| 4 · Jul–Oct 2027 | [[LAB-04 - Atmospheric Confirmatory Campaign|Atmospheric confirmation]] | QC-passed, shot-level dataset including failures and an independent realignment/session repeat. |
| 5 · Nov 2027–Feb 2028 | [[LAB-05 - Independent Prediction and Operating-Choice Check|Independent prediction and choice check]] | Untouched-session test of frozen M0/M1 and technical feasibility of a preselected operating choice. |
...
| --- | --- | --- |
| WP0, Sep–Dec 2026 | Define physical observables, breakdown marker, optical time zero, observation window, failed-shot codes and the reference operating service. Audit historical provenance and timing calibration. | Measurement specification, uncertainty budget and frozen distinction between historical evidence and new data. See [[HiLASE Trigger-to-Optical Timing - Verification Plan]]. |
...
| WP6, collect from WP0 and integrate Mar–Apr 2028 | Define technically admissible configurations using the validation result. For a pre-trigger choice, average over the configuration-dependent distribution of any post-laser descriptor. Compute bounded TCO, cost per compliant operation, scenario sensitivity and break-even boundaries. | Constrained operating choice or a documented lack of feasible/stable choice; Paper 2. See [[P3 - Techno-economic operating choice]]. |
