...
The technical/economic contribution is C3, represented by [[P3 - Techno-economic operating choice]]. It belongs to Chapter 6 and [[Paper 2 - Atmospheric Prediction and TCO]]. Technical feasibility comes from the same atmospheric probability/timing evidence used by C1/C2, rather than an assumed future breaker.
