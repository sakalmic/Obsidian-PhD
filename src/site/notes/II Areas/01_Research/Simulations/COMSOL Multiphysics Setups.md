...
The module, solver and numerical settings below are candidate setup notes, not a validated apparatus-specific configuration. Use the smallest atmospheric model required for [[H4 - Reduced predictive model]], document numerical convergence and compare M0/M1 on held-out data. Full coupled chemistry/flow and additional gases are not prerequisites for submission.
