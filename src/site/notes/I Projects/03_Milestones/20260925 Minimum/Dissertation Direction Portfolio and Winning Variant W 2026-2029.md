...
The A–F/O1–O8 assessments below are alternative-design background, not additional commitments. B supplies the predictive core; O1/O2 motivate follow-on SF₆-free research.
...
6. **Completion boundary:** mandatory Tier 1 evidence and TCO support August 2028 submission. The 2029 feasibility estimates in the historical portfolio concern alternative/follow-on programmes, not a dissertation deadline.

## Complete portfolio overview

Historical comparison of broader alternatives: the following feasibility estimates and medium-transfer references predate the selected Tier 1 boundary. They confer no mandatory status. Current W obligations are defined in the W section below and the reviewer report.

| ID | Direction | Principal contribution | Main additional requirement | Historical 2029 feasibility | Recommended role |
| --- | --- | --- | --- | --- | --- |
...
### Mandatory techno-economic assessment
...
Potential CO₂ collaboration belongs to Tier 2. Roles, apparatus, data rights, safety and authorship require a separate agreement. It is not a prerequisite for Tier 1 or its papers.
...
Test and document the atmospheric contributions, independent validation and bounded TCO, complete required publications and administrative obligations, and submit in August 2028. Tier 2/3 remain follow-on research.
