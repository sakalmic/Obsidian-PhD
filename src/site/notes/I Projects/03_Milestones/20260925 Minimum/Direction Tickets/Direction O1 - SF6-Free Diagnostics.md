---
{"dg-publish":true,"dg-permalink":"/direction-o1-sf6-free-diagnostics/","permalink":"/direction-o1-sf6-free-diagnostics/","title":"O1 · SF₆-Free Optical Diagnostics","noteIcon":"","created":"2026-09-10","updated":"2026-09-14","dg-note-properties":{"title":"O1 · SF₆-Free Optical Diagnostics","aliases":["Direction O1 - Optical Condition Diagnostics for SF6-Free Switchgear","Dissertation Direction O1"],"ticket_id":"DIR-O1","type":"project","status":"historical-alternative","context":"thesis","priority":"high","parent_project":"MIN-2026","direction_family":"outside-the-box","decision_state":"not-selected","date":"2026-09-10","last_updated":"2026-09-14","permalink":"/direction-o1-sf6-free-diagnostics/","scope_status":"superseded-by-review-2026-09-14"}}
---


# O1 · SF₆-Free Optical Diagnostics
...
Develop an optical or laser-assisted diagnostic that identifies insulation condition, discharge inception or degradation in fluorine-free switchgear media.

## Intended doctoral contribution

A calibrated diagnostic feature linked to a measurable dielectric-state or discharge outcome in a partner-defined test cell.
...
Enclosed approved gas cell; optical access; spectroscopy/imaging; HV source and recovery diagnostics; gas handling and industrial reference states.
...
| --- | --- | --- |
| Sep–Dec 2026 | Identify partner, target medium, diagnostic decision and regulatory use case. | G0: owner, cell, gases and measurable specification confirmed. |
| Jan–Jun 2027 | Commission reference states and obtain optical/electrical baseline. | G1: diagnostic signal separates at least two controlled states. |
| Jul–Dec 2027 | Run blinded or held-out state classification and robustness study. | D1: validated diagnostic dataset. |
| Jan–Apr 2028 | Independent repeat and partner-facing demonstrator/manuscript. | G2: industrial relevance supported by measured performance. |
| May–Aug 2028 | Integrate only if core thesis milestones remain protected. | Otherwise retain as grant/postdoctoral proposal. |

## Technical applications

Condition monitoring and qualification tools for fluorine-free switchgear.
...
Best commercial outside-the-box branch if an industrial partner and cell are secured.
...
- [[II Areas/01_Research/Concepts/Diagnostics - Timing EMP and Radiation\|Timing and optical diagnostics]]
- [[I Projects/03_Milestones/20260925 Minimum/Direction Tickets/Direction O2 - Fluorine-Free Media\|O2 · Fluorine-free dielectric recovery]]
