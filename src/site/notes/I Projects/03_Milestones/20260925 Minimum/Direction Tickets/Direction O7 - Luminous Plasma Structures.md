---
{"dg-publish":true,"permalink":"/i-projects/03-milestones/20260925-minimum/direction-tickets/direction-o7-luminous-plasma-structures/","title":"Direction O7 - Long-Lived Luminous Structures Inspired by Ball Lightning","noteIcon":"","created":"2026-09-10","updated":"2026-09-10","dg-note-properties":{"title":"Direction O7 - Long-Lived Luminous Structures Inspired by Ball Lightning","aliases":["Dissertation Direction O7"],"ticket_id":"DIR-O7","type":"project","status":"proposal","context":"thesis","priority":"high","parent_project":"MIN-2026","direction_family":"outside-the-box","decision_state":"not-selected","date":"2026-09-10","last_updated":"2026-09-10","permalink":"/direction-o7-luminous-plasma-structures/"}}
---


# Direction O7 — Long-Lived Luminous Structures Inspired by Ball Lightning
...
Investigate reproducible, long-lived luminous plasma or aerosol structures with measurable energy balance and lifetime, avoiding claims of reproducing natural ball lightning.

## Intended doctoral contribution

A laboratory phenomenon defined by formation probability, spectrum, lifetime, energy and repeatability, with competing mechanisms tested.
...
Discharge/laser chamber; time-resolved imaging and spectroscopy; electrical and thermal diagnostics; aerosol/chemistry controls; plasma-chemistry collaboration.
...
| --- | --- | --- |
| Sep–Dec 2026 | Define the observable phenomenon, mechanism candidates and safety envelope. | G0: reproducible target and expert collaborator. |
| Jan–Jun 2027 | Build low-energy controls and measure background luminous transients. | G1: lifetime exceeds diagnostic artefacts and is repeatable. |
| Jul–Dec 2027 | Vary composition, energy and geometry; test competing mechanisms. | D1: mechanism-discriminating dataset. |
| Jan–Apr 2028 | Independent replication and energy-balance model. | G2: publishable bounded phenomenon. |
| May 2028 onward | Continue as separate grant if G2 passes. | Do not make doctoral completion depend on success. |

## Technical applications

Plasma sources, combustion/chemical diagnostics, public-safety research and high-risk intellectual property.
...
Moonshot topic with high novelty and very high scope risk.
