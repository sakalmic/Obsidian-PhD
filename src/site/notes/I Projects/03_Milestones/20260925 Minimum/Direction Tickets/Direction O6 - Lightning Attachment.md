...
Translate laboratory channel and timing knowledge into controlled leader inception or attachment studies without claiming field-scale lightning control.

## Intended doctoral contribution

A validated laboratory-scale attachment experiment or a predictive scaling study tied to measurable channel lifetime and geometry.
...
Long-path laser/channel diagnostics; large-volume or impulse-HV facility; leader imaging; atmospheric monitoring; specialised partner and safety governance.
...
| --- | --- | --- |
| Sep–Dec 2026 | Define a laboratory attachment observable and identify a qualified facility partner. | G0: credible scaling path and access commitment. |
| Jan–Jun 2027 | Use core experiments to estimate channel lifetime and similarity limits. | G1: laboratory observable connected to existing evidence. |
| Jul–Dec 2027 | Run pilot only if facility and diagnostics are ready. | D1: feasibility dataset or validated scaling bound. |
| Jan–Apr 2028 | Decide whether a separate paper/grant is justified. | G2: no impact on dissertation core. |
| May 2028 onward | Develop field-scale work as postdoctoral/consortium programme. | Explicitly outside mandatory thesis scope. |

## Technical applications

Lightning-risk testing, research instrumentation and protected-site concepts.
...
High impact and high risk; best positioned as follow-on project.
