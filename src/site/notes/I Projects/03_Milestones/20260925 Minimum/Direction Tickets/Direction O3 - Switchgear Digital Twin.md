...
Create a probabilistic digital twin that propagates uncertain physical switching inputs into reliability, maintenance and lifecycle decisions.

## Intended doctoral contribution

A calibrated model whose predictions are tested against held-out laboratory or partner data and reported with uncertainty.
...
Core experimental dataset; system architecture and failure modes from a partner; statistical computing; versioned cost/reliability inputs.
...
| --- | --- | --- |
| Sep–Dec 2026 | Define system boundary, decisions, outputs and minimum partner data. | G0: identifiable model and validation dataset. |
| Jan–Jun 2027 | Build physical-probabilistic baseline using core measurements. | G1: uncertainty propagation and calibration verified. |
| Jul–Dec 2027 | Add reliability states and test predictions on untouched cases. | D1: validated digital-twin prototype. |
| Jan–Apr 2028 | Perform sensitivity, value-of-information and maintenance analyses. | G2: decisions robust to plausible uncertainty. |
| May–Aug 2028 | Publish bounded model and document limits. | No cost advantage claimed from speculative inputs. |

## Technical applications

Design optimisation, predictive maintenance and technology comparison for switchgear manufacturers and utilities.
...
Good fit with K13116; scientific value depends on real validation data.
