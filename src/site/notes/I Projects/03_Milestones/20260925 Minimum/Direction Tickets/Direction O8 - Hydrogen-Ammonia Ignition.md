---
{"dg-publish":true,"permalink":"/i-projects/03-milestones/20260925-minimum/direction-tickets/direction-o8-hydrogen-ammonia-ignition/","title":"Direction O8 - Laser-Plasma Ignition of Hydrogen and Ammonia","noteIcon":"","created":"2026-09-10","updated":"2026-09-10","dg-note-properties":{"title":"Direction O8 - Laser-Plasma Ignition of Hydrogen and Ammonia","aliases":["Dissertation Direction O8"],"ticket_id":"DIR-O8","type":"project","status":"proposal","context":"thesis","priority":"high","parent_project":"MIN-2026","direction_family":"outside-the-box","decision_state":"not-selected","date":"2026-09-10","last_updated":"2026-09-10","permalink":"/direction-o8-hydrogen-ammonia-ignition/"}}
---


# Direction O8 — Laser-Plasma Ignition of Hydrogen and Ammonia
...
Apply non-contact laser-plasma ignition and timing diagnostics to difficult low-carbon fuel mixtures.

## Intended doctoral contribution

A reproducible ignition-probability and delay map linked to mixture, pressure and measured plasma state.
...
Certified combustion chamber; gas mixing and exhaust handling; pressure/optical diagnostics; ignition reference; combustion-safety partner.
...
| --- | --- | --- |
| Sep–Dec 2026 | Secure combustion partner, chamber, target mixture and safety approval. | G0: named use case and facilities. |
| Jan–Jun 2027 | Transfer timing/metrology method and establish reference ignition. | G1: stable baseline and valid optical/electrical markers. |
| Jul–Dec 2027 | Map ignition probability and delay across a bounded mixture range. | D1: ignition dataset with censored failures. |
| Jan–Apr 2028 | Model channel-to-ignition coupling and repeat key cases. | G2: predictive or quantitative-bound result. |
| May 2028 onward | Publish as extension or follow-on programme. | Core LTSG thesis remains independent. |

## Technical applications

Hydrogen/ammonia engines, burners, turbines and safety/ignition systems.
...
Substantial commercial potential but a major domain and safety transition.
