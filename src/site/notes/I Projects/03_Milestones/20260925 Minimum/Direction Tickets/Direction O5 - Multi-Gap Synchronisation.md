---
{"dg-publish":true,"permalink":"/i-projects/03-milestones/20260925-minimum/direction-tickets/direction-o5-multi-gap-synchronisation/","title":"Direction O5 - Photonic Synchronisation of Multiple Spark Gaps","noteIcon":"","created":"2026-09-10","updated":"2026-09-10","dg-note-properties":{"title":"Direction O5 - Photonic Synchronisation of Multiple Spark Gaps","aliases":["Dissertation Direction O5"],"ticket_id":"DIR-O5","type":"project","status":"proposal","context":"thesis","priority":"high","parent_project":"MIN-2026","direction_family":"outside-the-box","decision_state":"not-selected","date":"2026-09-10","last_updated":"2026-09-10","permalink":"/direction-o5-multi-gap-synchronisation/"}}
---
...
Develop a scalable optical timing and distribution architecture for simultaneous triggering of multiple gaps.

## Intended doctoral contribution

A multi-channel demonstrator with quantified skew, joint reliability and sensitivity to optical-path or component variation.
...
Three or more matched gaps; optical splitters/fibres or free-space distribution; multi-channel acquisition; common clock and calibration source.
...
| --- | --- | --- |
| Sep–Dec 2026 | Specify channel count, skew target and distribution architecture. | G0: complete timing/error budget. |
| Jan–Jun 2027 | Qualify single- and two-gap building blocks. | G1: matched channels and reproducible calibration. |
| Jul–Dec 2027 | Demonstrate multi-gap triggering and model common/independent failures. | D1: scalable synchronization dataset. |
| Jan–Apr 2028 | Stress-test path imbalance and component tolerances. | G2: scaling law and design rules. |
| May–Aug 2028 | Retain as extension only after core evidence is complete. | Otherwise transfer to follow-up project. |

## Technical applications

Marx generators, pulsed-power arrays and distributed plasma systems.
...
Commercially interesting niche; high channel-count and safety complexity.
