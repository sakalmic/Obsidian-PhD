...
Evaluate a laser-triggered gap as the optically isolated initiation element in a named crowbar or commutation circuit.

## Intended doctoral contribution

An end-to-end demonstrator measuring trigger success, let-through energy, recovery and failure modes against a reference trigger.
...
Core LTSG; safe high-current source/load; energy absorption; current/voltage diagnostics; protection logic and industrially relevant waveform.
...
| --- | --- | --- |
| Sep–Dec 2026 | Select circuit, ratings, baseline trigger and system metric; complete safety review. | G0: named demonstrator and owner. |
| Jan–Jun 2027 | Validate optical trigger separately and simulate circuit stresses. | G1: component performance meets demonstrator requirements. |
| Jul–Dec 2027 | Build staged low-energy demonstrator and compare end-to-end performance. | D1: let-through/recovery dataset. |
| Jan–Apr 2028 | Scale only within approved limits; independently repeat. | G2: system benefit demonstrated or bounded. |
| May–Aug 2028 | Publish application result without extrapolating beyond tested energy. | Conditional thesis chapter. |

## Technical applications

Protection of capacitor banks, pulsed-power systems and specialised converters.
...
Fastest route to a tangible demonstrator if high-current infrastructure exists.
