---
{"dg-publish":true,"permalink":"/direction-b-channel-state-and-prediction-of-switching/","title":"Direction B - Channel State and Prediction of Switching","noteIcon":"","created":"2026-09-10","updated":"2026-09-10","dg-note-properties":{"title":"Direction B - Channel State and Prediction of Switching","aliases":["Dissertation Direction B"],"ticket_id":"DIR-B","type":"project","status":"proposal","context":"thesis","priority":"high","parent_project":"MIN-2026","direction_family":"core","decision_state":"not-selected","date":"2026-09-10","last_updated":"2026-09-10","permalink":"/direction-b-channel-state-and-prediction-of-switching/"},"dg-permalink":"/direction-b-channel-state-and-prediction-of-switching/"}
---
...
Determine whether measured plasma-channel state predicts breakdown more accurately than nominal laser energy and voltage alone.

## Intended doctoral contribution

A channel-informed predictive model evaluated on operating conditions or sessions excluded from calibration.
...
Option A stack plus synchronized gated imaging or optical-emission measurement, beam profiling and a reduced 0D/1D physical model.
...
| --- | --- | --- |
| Sep–Dec 2026 | Freeze channel descriptors, optical time zero, acquisition protocol and held-out validation rule. | G0: measurable channel proxy with uncertainty. |
| Jan–Apr 2027 | Build U50 baseline and characterize pulse energy, focus, continuity and channel evolution. | G1: channel variables reproducible enough for modelling. |
| May–Oct 2027 | Acquire synchronized switching/channel data and independently repeat selected conditions. | D1: frozen dataset for energy-only versus channel-informed comparison. |
| Nov 2027–Feb 2028 | Fit reduced model on calibration data and score untouched conditions. | G2: predictive gain demonstrated or quantitatively rejected. |
| Mar–Aug 2028 | Submit model paper and integrate contribution C-B/C-C into the thesis. | Validated model, failure map and reproducibility package. |

## Technical applications

Predictive setup control, adaptive laser triggering and diagnostics for plasma-assisted switching.
...
Recommended scientific core; balances novelty, feasibility and continuity.
