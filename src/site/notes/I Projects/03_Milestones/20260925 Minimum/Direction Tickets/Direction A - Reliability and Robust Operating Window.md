...
Establish a reproducible operating envelope for laser-assisted breakdown using probability, delay, jitter and misfire rate at controlled normalized voltage.

## Intended doctoral contribution

A traceable, independently repeated map of switching performance that remains valid under measured environmental and electrode-state variation.
...
Reference atmospheric-air spark gap; confirmed laser configuration; calibrated voltage and current channels; fast optical timing marker; environmental logger.
...
| --- | --- | --- |
| Sep–Dec 2026 | Freeze apparatus, safety, timing budget, metadata and laser-off controls. | G0: reproducible dry run and calibrated time origin. |
| Jan–Apr 2027 | Measure self-breakdown U50 across days; screen normalized voltage, pulse energy and focus. | G1: stable baseline and viable laser effect. |
| May–Oct 2027 | Run powered confirmatory campaign; retain misfires; independently repeat the main result. | D1: frozen operating-window dataset and Paper 1 draft. |
| Nov 2027–Apr 2028 | Complete mixed/survival analysis, robustness bounds and manuscript. | D2: submitted paper and thesis results chapter. |
| May–Aug 2028 | Integrate results, limitations and reproducibility package. | Final thesis contribution C-A. |

## Technical applications

Pulsed-power triggering, laboratory HV switches and qualification of optically isolated trigger systems.
...
Lowest technical risk; best fallback if advanced channel diagnostics are unavailable.
...
- [[II Areas/03_Thesis/Claims/H1 - Laser-assisted breakdown probability\|H1 · Breakdown probability]]
