---
{"dg-publish":true,"dg-permalink":"/direction-e-synchronization-of-two-spark-gaps/","permalink":"/direction-e-synchronization-of-two-spark-gaps/","title":"E · Dual-Gap Synchronisation","noteIcon":"","created":"2026-09-10","updated":"2026-09-14","dg-note-properties":{"title":"E · Dual-Gap Synchronisation","aliases":["Direction E - Synchronization of Two Spark Gaps","Dissertation Direction E"],"ticket_id":"DIR-E","type":"project","status":"historical-alternative","context":"thesis","priority":"high","parent_project":"MIN-2026","direction_family":"core","decision_state":"not-selected","date":"2026-09-10","last_updated":"2026-09-14","permalink":"/direction-e-synchronization-of-two-spark-gaps/","scope_status":"superseded-by-review-2026-09-14"}}
---


# E · Dual-Gap Synchronisation
...
Quantify whether one optical source can reduce relative timing error and misfire probability when triggering two separated discharge gaps.

## Intended doctoral contribution

A two-gap timing and covariance model with an independently repeated synchronization result.
...
Two matched gaps and diagnostic channels; optical splitting/delivery; common timing reference; sufficient oscilloscope channels and safe energy handling.
...
| --- | --- | --- |
| Sep–Dec 2026 | Define synchronization metric, common-mode timing budget and safe two-gap circuit. | G0: approved architecture and single-gap reference. |
| Jan–Jun 2027 | Validate each gap separately and characterize optical path imbalance. | G1: both gaps meet the same baseline acceptance criteria. |
| Jul–Dec 2027 | Acquire paired outcomes and estimate relative delay, covariance and joint misfire probability. | G2: measurable synchronization benefit versus independent triggering. |
| Jan–Apr 2028 | Independent repeat and demonstrator manuscript. | D1: two-gap dataset or documented stop decision. |
| May–Aug 2028 | Integrate only if the core single-gap work is already complete. | Conditional application chapter. |

## Technical applications

Synchronized pulsed-power stages, Marx generators, multi-channel plasma systems and trigger distribution.
...
Clear demonstrator value but doubles apparatus and diagnostic complexity.
...
- [[II Areas/03_Thesis/Claims/P1 - Delay and jitter response\|P1 · Delay and jitter]]
